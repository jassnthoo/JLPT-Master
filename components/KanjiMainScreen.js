...
export default function KanjiMainScreen({ navigation }) {
  ...
  const lessons = [
    {
      id: 1,
      title: '第1週 (1) - 駐車場',
      description: 'Kanji cơ bản về giao thông và đỗ xe',
      duration: '12 kanji',
      progress: 100,
      status: 'completed',
      isCompleted: true
    },
    {
      id: 2,
      title: '第2週 (2) - 会社',
      description: 'Kanji về công ty và công việc',
      duration: '15 kanji',
      progress: 100,
      status: 'completed',
      isCompleted: true
    },
    {
      id: 3,
      title: '第3週 (3) - 学校',
      description: 'Kanji về trường học và giáo dục',
      duration: '18 kanji',
      progress: 75,
      status: 'in-progress',
      isCompleted: false
    },
    {
      id: 4,
      title: '第4週 (4) - 病院',
      description: 'Kanji về bệnh viện và sức khỏe',
      duration: '20 kanji',
      progress: 40,
      status: 'in-progress',
      isCompleted: false
    },
    {
      id: 5,
      title: '第5週 (5) - 買い物',
      description: 'Kanji về mua sắm và cửa hàng',
      duration: '16 kanji',
      progress: 0,
      status: 'not-started',
      isCompleted: false
    },
    {
      id: 6,
      title: '第6週 (6) - 料理',
      description: 'Kanji về nấu ăn và món ăn',
      duration: '14 kanji',
      progress: 0,
      status: 'not-started',
      isCompleted: false
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Học kanji</Text>
      ...
      <ScrollView style={styles.lessonsList} showsVerticalScrollIndicator={false}>
        {lessons.map((lesson) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('KanjiFlashcard', { lesson })}
          >
