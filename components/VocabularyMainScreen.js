...
export default function VocabularyMainScreen({ navigation }) {
  ...
  const lessons = [
    {
      id: 1,
      title: 'Unit 01 - Bài 1',
      description: 'Từ vựng cơ bản về giới thiệu bản thân',
      duration: '15 từ vựng',
      progress: 100,
      status: 'completed',
      isCompleted: true
    ...
    },
    {
      id: 6,
      title: 'Unit 06 - Bài 6',
      description: 'Từ vựng về giao thông và phương tiện',
      duration: '19 từ vựng',
      progress: 0,
      status: 'not-started',
      isCompleted: false
      ...
      <ScrollView style={styles.lessonsList} showsVerticalScrollIndicator={false}>
        {lessons.map((lesson) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('VocabularyFlashcard', { lesson })}
          >
